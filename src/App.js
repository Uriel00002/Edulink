                  ...
                  : ( 
                    ...
                    <Routes>
                      ...
                      <Route path="/users/*" element={<Routes>
                        ...
                        <Route path="/profiles" element={<IndexCRUD nameAPI="profiles" nameView="Perfiles" permissions={{c:[128,7],r:[128,3,4,5,6,7],rbid:[128,2,3,4,5,6,7],u:[128,7],d:[128,7]}} />}/*rbid 0,1 u 1*//>
                        <Route path='/addresses' element={<IndexCRUD nameAPI="addresses" nameView="Direcciones" permissions={{c:[128,7],r:[128,3,4,5,6,7],rbid:[128,2,3,4,5,6,7],u:[128,7],d:[128,7]}} />}/*c 1 rbid 0,1 u 1 d 1*//>
                        <Route path='/positions' element={<IndexCRUD nameAPI="positions" nameView="Puestos" permissions={{c:[128,8],r:[128,8],rbid:[128,2,3,4,5,6,7,8],u:[128,8],d:[128,8]}} />} />
                        <Route path='/employees' element={<IndexCRUD nameAPI="employees" nameView="Empleados" permissions={{c:[128,8],r:[128,8],rbid:[128,2,3,4,5,6,7,8],u:[128,8],d:[128,8]}} />} />
                        <Route path="*" element={<Navigate to="/" />} />
                      </Routes>} />
                      <Route path="/subjects/*" element={<Routes>
                        <Route path="/" element={<IndexCRUD nameAPI="subjects" nameView="Materias" permissions={{c:[128,7],r:[128,4,5,6,7],rbid:[128,2,3,4,5,6,7],u:[128,7],d:[128,7]}} />} />
                        <Route path="*" element={<Navigate to="/" />} />
                      </Routes>} />
                      <Route path="/grades/*" element={<Routes>
                        <Route path="/" element={<IndexCRUD nameAPI="grades" nameView="Calificaciones" permissions={{c:[128,7],r:[128,3,4,5,6,7],rbid:[128,2,3,4,5,6,7],u:[128,2,7],d:[128,7]}} />} />
                        <Route path="*" element={<Navigate to="/" />} />
                      </Routes>} />
                      <Route path="/categories/*" element={<Routes>
                        <Route path="/" element={<IndexCRUD nameAPI="categories" nameView="Categorías de aulas" permissions={{c:[128,7],r:[128,7],rbid:[128,2,3,4,5,6,7],u:[128,7],d:[128,7]}} />} />
                        <Route path="*" element={<Navigate to="/" />} />
                      </Routes>} />
                      <Route path="/classrooms/*" element={<Routes>
                        <Route path="/" element={<IndexCRUD nameAPI="classrooms" nameView="Salones" permissions={{c:[128,7],r:[128,3,4,5,6,7],rbid:[128,2,3,4,5,6,7],u:[128,7],d:[128,7]}} />} />
                        <Route path="*" element={<Navigate to="/" />} />
                      </Routes>} />
                      <Route path="/career/*" element={<Routes>
                        <Route path="/" element={<IndexCRUD nameAPI="careers" nameView="Carreras" permissions={{c:[128,7],r:[128,4,5,6,7],rbid:[128,2,3,4,5,6,7],u:[128,7],d:[128,7]}} />} />
                        <Route path="*" element={<Navigate to="/" />} />
                      </Routes>} />
                      <Route path="/buildings/*" element={<Routes>
                        <Route path="/" element={<IndexCRUD nameAPI="buildings" nameView="Edificios" permissions={{c:[128,7],r:[128,5,6,7],rbid:[128,2,3,4,5,6,7],u:[128,7],d:[128,7]}} />} />
                        <Route path="*" element={<Navigate to="/" />} />
                      </Routes>} />
                      <Route path="/groups/*" element={<Routes>
                        <Route path="/" element={<IndexCRUD nameAPI="groups" nameView="Grupos" permissions={{c:[128,4,7],r:[128,3,4,5,6,7],rbid:[128,2,3,4,5,6,7],u:[128,4,7],d:[128,7]}} />} />
                        <Route path="*" element={<Navigate to="/" />} />
                      </Routes>} />
                      ...
                      <Route path="/sicah/academiccharges/*" element={<Routes>
                        <Route path="/" element={<IndexCRUD nameAPI="academiccharges" nameView="Carga horaria" permissions={{c:[128,4,7],r:[128,4,7],rbid:[128,3,4,5,6,7],u:[128,4,7],d:[128,4,7]}} />} />
                        <Route path="*" element={<Navigate to="/" />} />
                      </Routes>} />
